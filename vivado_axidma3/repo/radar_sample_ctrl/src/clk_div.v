...
(
    ...
    input [C_S_AXI_DATA_WIDTH-1:0] prt_count      , //PRT
    input [C_S_AXI_DATA_WIDTH-1:0] pulse_width    , //sample counter of each pulse interval
...
(* MARK_DEBUG = "TRUE" *)reg [C_S_AXI_DATA_WIDTH-1: 0] count;
reg [C_S_AXI_DATA_WIDTH-1: 0] ext_count;
reg [22: 0] led_count;
